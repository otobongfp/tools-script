...
const transactionsPath = path.join(__dirname, "../data/blocks-monthly.json");
...
async function getBlocks() {
  try {
    ...
    //Approx. 44500 blocks are prod. per day
    const height = currentBlockHeight.data.height;
    let from = height - 44500;
    let to = from + 90;

    console.log("Monthly mined blocks");
